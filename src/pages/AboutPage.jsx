...
const AboutPage = () => {
  return (
    <Container>
      ...
      <p className="phome">
        <p className="pAbuot">Login:</p> You can register on the site for maximum use of the site service
        You can log in and register on the designated pages in the nav bar. The
        details will be saved in the data and the payload will be saved in
      ...
      <p className="phome">
      <p className="pAbuot">Menu:</p> The menu appears in 2 views for the user's convenience. There is
        also the option to sort by categories or search in the search field that
      ...
      <p className="phome">
      <p className="pAbuot">Contact:</p> On this page you can fill out a contact form. A connected user
        can also open a recommendation page and recommend us:) The
        recommendations will be saved and displayed with the user's profile
        picture on the home page. Profile picture: by clicking on the profile
        picture, the profile page will open where the user can change his
        personal details by clicking OK, the new details will be saved and the
        picture will change in the nav bar and recommendations. crm: an admin
        user will also be able to enter the crm page to view all the order
        forms.
      </p>
      <p className="phome">
      <p className="pAbuot">footer:</p> at the bottom of each page appears the footer with the
        restaurant's logo and contact information in an experiential and
        convenient way for the user. Clicking on the icons will open the
        following:
        <br></br>
